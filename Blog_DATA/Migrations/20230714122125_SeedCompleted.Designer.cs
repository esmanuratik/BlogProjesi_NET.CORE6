...
namespace Blog_DATA.Migrations
{
    ...
    [Migration("20230714122125_SeedCompleted")]
            ...
            modelBuilder.Entity("Blog_ENTİTY.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6038e9c0-0de1-4b0d-abbe-1ad3e72c8db3"),
                            ...
                            CreatedDate = new DateTime(2023, 7, 14, 15, 21, 25, 539, DateTimeKind.Local).AddTicks(4891),
                        ...
                        new
                        {
                            Id = new Guid("65690f1c-7f2b-44cd-952c-14521838d6fe"),
                            ...
                            CreatedDate = new DateTime(2023, 7, 14, 15, 21, 25, 539, DateTimeKind.Local).AddTicks(4896),
            ...
            modelBuilder.Entity("Blog_ENTİTY.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 7, 14, 15, 21, 25, 539, DateTimeKind.Local).AddTicks(5099),
                            IsDeleted = false,
                            Name = "Asp.Net Core"
                        },
                        new
                        {
                            ...
                            CreatedBy = "Visual Studio Admin Test",
                            CreatedDate = new DateTime(2023, 7, 14, 15, 21, 25, 539, DateTimeKind.Local).AddTicks(5114),
                            IsDeleted = false,
                            Name = "Visual Studio"
                        });
                });
            ...
            modelBuilder.Entity("Blog_ENTİTY.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 7, 14, 15, 21, 25, 539, DateTimeKind.Local).AddTicks(5194),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Visual Studio Admin Test",
                            CreatedDate = new DateTime(2023, 7, 14, 15, 21, 25, 539, DateTimeKind.Local).AddTicks(5197),
